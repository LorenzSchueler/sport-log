...
class AlarmUtils {
  AlarmUtils({
    required this._routeAlarmDistance,
    required this._routeTrack,
    required this._getSessionTrack,
    required this._getTrackingMode,
  });

  final List<Position> Function() _getSessionTrack;
