              ...
              child: ListView(
                children: [
                  ListTile(
                    ...
                    leading: Icon(AppIcons.dumbbell, color: onBackgroundColor),
                    onTap: () =>
                  ...
                  ListTile(
                    ...
                    leading: Icon(AppIcons.exercise, color: onBackgroundColor),
                    onTap: () =>
                        Navigator.of(context).newBase(Routes.movementOverview),
                    selected: selectedRoute == Routes.movementOverview,
                  ),
                  ListTile(
                    leading: Icon(AppIcons.stopwatch, color: onBackgroundColor),
                  ...
                  ListTile(
                    leading:
                        Icon(AppIcons.fileDownload, color: onBackgroundColor),
                  ...
                  ListTile(
                    leading: Icon(AppIcons.heartbeat, color: onBackgroundColor),
                  ...
                  ListTile(
                    leading:
                        Icon(AppIcons.playCircle, color: onBackgroundColor),
                  ...
                  ListTile(
                    leading: Icon(AppIcons.settings, color: onBackgroundColor),
