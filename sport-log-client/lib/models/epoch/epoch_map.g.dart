...
EpochMap _$EpochMapFromJson(Map<String, dynamic> json) => EpochMap(
  ...
  strengthSession: const IdConverter().fromJson(
    json['strength_session'] as String,
  ),
  ...
  metconSession: const IdConverter().fromJson(json['metcon_session'] as String),
  metconMovement: const IdConverter().fromJson(
    json['metcon_movement'] as String,
  ),
  cardioSession: const IdConverter().fromJson(json['cardio_session'] as String),
  route: const IdConverter().fromJson(json['route'] as String),
  platform: const IdConverter().fromJson(json['platform'] as String),
  platformCredential: const IdConverter().fromJson(
    json['platform_credential'] as String,
  ),
  actionProvider: const IdConverter().fromJson(
    json['action_provider'] as String,
  ),
...
Map<String, dynamic> _$EpochMapToJson(EpochMap instance) => <String, dynamic>{
  ...
  'platform_credential': const IdConverter().toJson(
    instance.platformCredential,
  ),
