...
StrengthSet _$StrengthSetFromJson(Map<String, dynamic> json) => StrengthSet(
  ...
  strengthSessionId: const IdConverter().fromJson(
    json['strength_session_id'] as String,
  ),
...
Map<String, dynamic> _$StrengthSetToJson(
  StrengthSet instance,
) => <String, dynamic>{
  'id': const IdConverter().toJson(instance.id),
  'user_id': const IdConverter().toJson(instance._userId),
  'strength_session_id': const IdConverter().toJson(instance.strengthSessionId),
