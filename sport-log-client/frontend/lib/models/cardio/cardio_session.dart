...
class NewCardioSession {
  ...
  factory NewCardioSession.fromJson(Map<String, dynamic> json) => _$NewCardioSessionFromJson(json);
  Map<String, dynamic> toJson() => _$NewCardioSessionToJson(this);
}
