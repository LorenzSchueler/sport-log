...
void addTestDataToMovementRepo(MovementRepository movementRepo) {
  ...
  movementRepo.createMovement(NewMovement(name: "Push up", category: MovementCategory.strength, description: "A push-up (sometimes called a press-up in British English) is a common calisthenics exercise beginning from the prone position. By raising and lowering the body using the arms, push-ups exercise the pectoral muscles, triceps, and anterior deltoids, with ancillary benefits to the rest of the deltoids, serratus anterior, coracobrachialis and the midsection as a whole."));
  ...
  movementRepo.createMovement(NewMovement(name: "Plank", category: MovementCategory.strength, description: "The plank (also called a front hold, hover, or abdominal bridge) is an isometric core strength exercise that involves maintaining a position similar to a push-up for the maximum possible time."));
